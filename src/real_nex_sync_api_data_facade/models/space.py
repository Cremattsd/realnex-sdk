...
class Space(BaseModel):
    ...
    :param crm_property_key: crm_property_key, defaults to None
    :type crm_property_key: str, optional
    :param property: property, defaults to None
    :type property: Property, optional
    ...
    :type tenant: PropertyContact, optional
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if crm_property_key is not None:
            self.crm_property_key = self._define_str(
                "crm_property_key", crm_property_key, nullable=True
            )
        if property is not None:
            self.property = self._define_object(property, Property)
        ...
        if tenant is not None:
            self.tenant = self._define_object(tenant, PropertyContact)
