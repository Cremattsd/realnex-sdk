...
class LeaseCompDetails(BaseModel):
    """LeaseCompDetails
    ...
    :param import_source: import_source, defaults to None
    :type import_source: str, optional
    :param import_record: import_record, defaults to None
    :type import_record: str, optional
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if import_source is not None:
            self.import_source = self._define_str(
                "import_source", import_source, nullable=True
            )
        if import_record is not None:
            self.import_record = self._define_str(
                "import_record", import_record, nullable=True
            )
