...
class PropertyUsage(BaseModel):
    ...
    :param traffec_count: traffec_count, defaults to None
    :type traffec_count: str, optional
    ...
    def __init__(
        ...
        **kwargs
        ...
        if traffec_count is not None:
            self.traffec_count = self._define_str(
                "traffec_count", traffec_count, nullable=True
            )
